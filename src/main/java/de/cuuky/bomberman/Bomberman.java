...
import de.cuuky.bomberman.commands.InfiniteTnTCommand;
import de.cuuky.bomberman.commands.RebuildCommand;
import de.cuuky.bomberman.commands.SetLobbyCommand;
import de.cuuky.bomberman.commands.SetLocCommand;
import de.cuuky.bomberman.commands.SetSpawnCommand;
import de.cuuky.bomberman.commands.StartCommand;
import de.cuuky.bomberman.commands.VoteCommand;
...
import de.cuuky.bomberman.killswitch.KillSwitch;
import de.cuuky.bomberman.listener.BlockPlaceListener;
import de.cuuky.bomberman.listener.CancelListener;
import de.cuuky.bomberman.listener.EntityDamageByEntityListener;
import de.cuuky.bomberman.listener.EntityDamageListener;
import de.cuuky.bomberman.listener.EntityExplodeListener;
import de.cuuky.bomberman.listener.PlayerChatListener;
import de.cuuky.bomberman.listener.PlayerDeathListener;
import de.cuuky.bomberman.listener.PlayerInteractListener;
import de.cuuky.bomberman.listener.PlayerJoinListener;
import de.cuuky.bomberman.listener.PlayerLoginListener;
import de.cuuky.bomberman.listener.PlayerMoveListener;
import de.cuuky.bomberman.listener.PlayerQuitListener;
import de.cuuky.bomberman.listener.ServerListPingListener;
...
public class Bomberman extends JavaPlugin {
	...
	public void onDisable() {
		...
		lm.save();
		for (Player pl : Bukkit.getOnlinePlayers())
			pl.kickPlayer("�cServer startet jetzt neu...");
