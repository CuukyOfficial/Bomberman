...
public class PyroPowerupJob extends AbstractPowerupJob {

    protected PyroPowerupJob(RunningHeartbeat heartbeat) {
        super(heartbeat, PowerupEffect.PYRO, Particle.FLAME);
    }
