...
public class BombermanConfig {
    ...
    public static final IntegerConfigEntry LOBBY_DELAY = IntegerConfigEntry.of(CONFIG, "lobby.delay", "The amount of time that should be spent waiting for more players in seconds", 30, Validator.INTEGER_NOT_NEGATIVE);
